...
class ListProductResponseModel {
    ...
    factory ListProductResponseModel.fromJson(String str) => ListProductResponseModel.fromMap(json.decode(str));

    String toJson() => json.encode(toMap());

    factory ListProductResponseModel.fromMap(Map<String, dynamic> json) => ListProductResponseModel(
