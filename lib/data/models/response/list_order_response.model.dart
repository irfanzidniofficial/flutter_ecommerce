...
class ListOrderResponseModel {
    ...
    factory ListOrderResponseModel.fromJson(String str) => ListOrderResponseModel.fromMap(json.decode(str));

    String toJson() => json.encode(toMap());

    factory ListOrderResponseModel.fromMap(Map<String, dynamic> json) => ListOrderResponseModel(
        data: json["data"] == null ? [] : List<Order>.from(json["data"]!.map((x) => Order.fromMap(x))),
